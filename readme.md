...
Вне тела шаблона можно объявлять общие переменные, доступные для всех шаблонов. Синтаксис аналогичен синтаксису констант. В теле шаблона нельзя переопределить значение глобальной переменной. Переменные сохраняются в Snakeskin.Vars.
