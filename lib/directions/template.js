var $freeze$0 = Object.freeze;var $defProps$0 = Object.defineProperties;var $TS$0 = ["['", "']"];$TS$0 = $freeze$0($defProps$0($TS$0, {"raw": {"value": $TS$0}}));var $TS$1 = ["\n								if (", " == null) {\n									", " = {};\n								}\n							"];$TS$1 = $freeze$0($defProps$0($TS$1, {"raw": {"value": $TS$1}}));var $TS$2 = $freeze$0($defProps$0(["\n				var __THIS__ = this,\n					__CALLEE__ = __ROOT__", ",\n					callee = __CALLEE__;\n\n				if (!callee.Blocks) {\n					var __BLOCKS__ = __CALLEE__.Blocks = {},\n						blocks = __BLOCKS__;\n				}\n\n				var __RESULT__ = ", ",\n					__COMMENT_RESULT__,\n					__NODE__,\n					$_;\n\n				function getTplResult(opt_clear) {\n					var res = ", ";\n\n					if (opt_clear) {\n						__RESULT__ = ", ";\n					}\n\n					return res;\n				}\n\n				function clearTplResult() {\n					__RESULT__ = ", ";\n				}\n\n				var __RETURN__ = false,\n					__RETURN_VAL__;\n\n				var TPL_NAME = \"", "\",\n					PARENT_TPL_NAME", ";\n\n				", "\n			"], {"raw": {"value": $freeze$0(["\n				var __THIS__ = this,\n					__CALLEE__ = __ROOT__", ",\n					callee = __CALLEE__;\n\n				if (!callee.Blocks) {\n					var __BLOCKS__ = __CALLEE__.Blocks = {},\n						blocks = __BLOCKS__;\n				}\n\n				var __RESULT__ = ", ",\n					__COMMENT_RESULT__,\n					__NODE__,\n					\\$_;\n\n				function getTplResult(opt_clear) {\n					var res = ", ";\n\n					if (opt_clear) {\n						__RESULT__ = ", ";\n					}\n\n					return res;\n				}\n\n				function clearTplResult() {\n					__RESULT__ = ", ";\n				}\n\n				var __RETURN__ = false,\n					__RETURN_VAL__;\n\n				var TPL_NAME = \"", "\",\n					PARENT_TPL_NAME", ";\n\n				", "\n			"])}}));var $TS$3 = ["\n						", "\n						return ", ";\n					};\n\n					Snakeskin.cache[\"", "\"] = this", ";\n				"];$TS$3 = $freeze$0($defProps$0($TS$3, {"raw": {"value": $TS$3}}));/**
 * Номер итерации,
...
, escapeDoubleQuote(tplName)
, parentTplName ? ((" = \"" + (escapeDoubleQuote(parentTplName))) + "\"") : ''
...
, escapeDoubleQuote(tplName), concatProp(tplName)
));
			}
