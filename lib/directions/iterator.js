					...
					'for (' + this.multiDeclVar('__KEY__', false) + 'in ' + cache + ') {' +
						...
						(function()  {
							...
							for (var i = 0; i < args.length; i++) {
								switch (i) {
									case 0: {
										str += this$0.multiDeclVar(args[i] + ' = __TMP__[__KEY__]');
									} break;

									case 1: {
										str += this$0.multiDeclVar(args[i] + ' = __KEY__');
									} break;

									case 2: {
										str += this$0.multiDeclVar(args[i] + ' = __TMP__');
									} break;

									case 3: {
										str += this$0.multiDeclVar(args[i] + ' = __I__');
									} break;

									case 4: {
										str += this$0.multiDeclVar(args[i] + ' = __I__ === 0');
									} break;

									case 5: {
										str += this$0.multiDeclVar(args[i] + ' = __I__ === __TMP_LENGTH__ - 1');
									} break;

									case 6: {
										str += this$0.multiDeclVar(args[i] + ' = __TMP_LENGTH__');
									} break;
								}
							}
