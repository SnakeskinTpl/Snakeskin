/**
 * Если true или строка (название), то значит идёт декларация прототипа
 * @type {(boolean|string)}
 */
...
Snakeskin.addDirective(
	...
	function (command, commandLength) {
		...
		if (!name) {
			...
			name = '__ANONYMUS__' + (this.protoStart ? this.protoStart : this.proto ? this.proto.name : '');
		}
