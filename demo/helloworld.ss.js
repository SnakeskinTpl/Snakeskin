/* Snakeskin v7.0.0, key <[false,"umd","tpls",null,false,"\\n",false,null,"stringConcat",true,null,true,"i18n",null,["{{","}}"],"bem",{"global":["html","undef"],"local":["undef"]},true]>, label <>, includes <>, generated at <1461689931487>.
...
(function(global, factory) {
	...
	__LOCAL__.$__0_0_39895 = undefined; /* Snakeskin template: demo.helloWorld; name  */
	...
	exports.demo.helloWorld = Snakeskin.decorate([], function helloWorld(name) {
		...
		$class = 'hello';
		var ____TAG___tag_284 = ('div').trim() || 'div';
		__RESULT__ = __GET_XML_ATTRS_DECL_START__(__RESULT__, ____TAG___tag_284, 'stringConcat', false, false);
		var ____ATTR_CACHE___tag_284 = {};
		____ATTR_CACHE___tag_284['class'] = ['hello'].concat(____ATTR_CACHE___tag_284['class'] || []);
		__RESULT__ = __GET_XML_ATTRS_DECL_END__(__RESULT__, ____TAG___tag_284, ____ATTR_CACHE___tag_284, false, false, false);
		var ____CALL_CACHE___tag_284 = __RESULT__;
		__RESULT__ = __GET_XML_TAG_DECL_END__(__RESULT__, ____TAG___tag_284, false, __INLINE_TAGS__[____TAG___tag_284], false, false, false);
		__RESULT__ += 'Hello ';
		...
		__RESULT__ += '!';
		$class = '';
		var ____CALL_TMP___tag_340 = __RESULT__ instanceof Raw ? __RESULT__.value : __RESULT__;
		__RESULT__ = __GET_END_XML_TAG_DECL__(__RESULT__, ____TAG___tag_284, false, __INLINE_TAGS__[____TAG___tag_284], ____ATTR_CACHE___tag_284, ____CALL_CACHE___tag_284, ____CALL_TMP___tag_340, false, false, false);
