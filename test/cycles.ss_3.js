...
,xml,false,false,,stringBuffer,true,true,true,,true,true,i18n>, label <1413886610336>, includes <>, generated at <1414827000301>.
...
(function() {
    ...
    function exec() {
        ...
        var $_ = __LOCAL__['$_693eb']; /* Snakeskin template: cycles_index; i  */
        this.cycles_index = function(i) {
            ...
            for (var __j__for_67 = 0;
                (__j__for_67 < 3);
                (__j__for_67++)) {
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__j__for_67), false, false));
            }
            __RESULT__.push(' ');
            while (i++ < 3) {
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(i), false, false));
            }
            __RESULT__.push(' ');
            do {
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(i), false, false));
        ...
        this.cycles_index2 = function(i) {
            ...
            for (var __j__for_334 = 0;
                (__j__for_334 < 3);
                (__j__for_334++)) {
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__j__for_334), false, false));
                break;
            }
            __RESULT__.push(' ');
            while (i++ < 3) {
