...
,xml,false,false,,stringBuffer,true,true,true,,true,true,i18n>, label <1413959606683>, includes <>, generated at <1414919438507>.
...
(function() {
    ...
    function exec() {
        ...
        var $_ = __LOCAL__['$_9dd81']; /* Snakeskin template: escape_index;  */
        this.escape_index = function() {
            ...
            if (('2') != null && ('2') != '' && (__STR__ || true)) {
                if (__NODE__) {
                    ...
                    __RESULT__.push(' ' + '2' + (__STR__ ? '="' + __STR__ + '"' : ''));
                }
            }
            __RESULT__.push(' ');
            __RESULT__.push('\'' + __FILTERS__.html(2, false, false) + '\'');
            __RESULT__.push(' ');
            __RESULT__.push('\'#{/* 1 + */2}\'');
            __RESULT__.push(' ');
            __STR__ = '';
            ...
            if (('a') != null && ('a') != '' && (__STR__ || false)) {
                if (__NODE__) {
                    ...
                    __RESULT__.push(' ' + 'a' + (__STR__ ? '="' + __STR__ + '"' : ''));
                }
            }
            __RESULT__.push(' ');
        ...
        this.escape_index2 = function() {
            ...
            var TPL_NAME = "escape_index2",
                PARENT_TPL_NAME;
            __RESULT__.push('{attr a = {«b»: “2”}} /// 1 /* 2 */ \\1 \\« 2 » ');
            return __RESULT__.join('');
        };
        ...
        this.escape_index3 = function() {
            ...
            var TPL_NAME = "escape_index3",
                PARENT_TPL_NAME;
            __RESULT__.push('<div ');
            __RESULT__.push(__FILTERS__.html('onclick="alert()" foo', true, false));
            __RESULT__.push('="2');
            __RESULT__.push(__FILTERS__.html(' bar = 1', true, true));
            __RESULT__.push('"></div> ');
            __STR__ = '';
            __J__ = 0;
            ...
            if (('' + __FILTERS__.html('foo = 1 bar', true, true) + '') != null && ('' + __FILTERS__.html('foo = 1 bar', true, true) + '') != '' && (__STR__ || false)) {
                if (__NODE__) {
                    ...
                    __RESULT__.push(' ' + '' + __FILTERS__.html('foo = 1 bar', true, true) + '' + (__STR__ ? '="' + __STR__ + '"' : ''));
                }
            }
            __RESULT__.push(' ');
            return __RESULT__.join('');
        ...
        this.escape_index4 = function() {
            ...
            var TPL_NAME = "escape_index4",
                PARENT_TPL_NAME;
            __RESULT__.push(__FILTERS__.html(typeof /foo["]bar\/\//, false, false));
            __RESULT__.push(' ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(!/foo/.test('foo')), false, false));
            __RESULT__.push(' ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(!/foo/.test('foo')) % /[\/]/, false, false));
            __RESULT__.push(' ');
            __RESULT__.push('' + __FILTERS__.html(__FILTERS__.undef(!/foo/.test('foo')), false, false) + '');
        ...
        this.escape_index5 = function() {
            ...
            var TPL_NAME = "escape_index5",
                PARENT_TPL_NAME;
            __RESULT__.push('<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/> ');
            return __RESULT__.join('');
        };
            ...
            if (('http-equiv') != null && ('http-equiv') != '' && (__STR__ || false)) {
                if (__TMP__[('http-equiv')] != null) {
                    ...
                    if (__NODE__) {
                        ...
                        __RESULT__.push(' ' + 'http-equiv' + (__STR__ ? '="' + __STR__ + '"' : ''));
                    }
                }
            }
            __STR__ = '';
            ...
            if (('content') != null && ('content') != '' && (__STR__ || false)) {
                if (__TMP__[('content')] != null) {
                    ...
                    if (__NODE__) {
                        ...
                        __RESULT__.push(' ' + 'content' + (__STR__ ? '="' + __STR__ + '"' : ''));
                    }
                }
            }
