...
,xml,false,false,,stringBuffer,true,true,true,,true,true,i18n>, label <1413886610357>, includes <>, generated at <1414919438771>.
...
(function() {
    ...
    function exec() {
        ...
        var $_ = __LOCAL__['$_84b05']; /* Snakeskin template: param_base; a,b  */
        ...
        this.param_base3 = function(a) {
            ...
            ____I_PROTO___foo_with_52: while (____I_PROTO___foo_with_52--) {
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__a__proto_405.c), false, false));
                __RESULT__.push(' ');
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(b), false, false));
                __RESULT__.push(' ');
            }
