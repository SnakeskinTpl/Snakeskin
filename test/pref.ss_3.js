...
,xml,false,false,,stringBuffer,true,true,true,,true,true,i18n>, label <1413886610358>, includes <>, generated at <1414827000946>.
    ...
    function exec() {
        ...
        this.pref_index = function() {
            ...
            if (1) {
                ...
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__VARS__.pref_global), false, false));
                __RESULT__.push(' {pref_global2} {/} ');
            }
            if (1) {
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__VARS__.pref_global), false, false));
                __RESULT__.push(' ');
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__VARS__.pref_global2), false, false));
                __RESULT__.push(' #');
            }
            __RESULT__.push(' ');
