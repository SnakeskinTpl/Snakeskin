...
,xml,false,true,,stringBuffer,true,true,true,,true,true,i18n>, label <1414071186510>, includes <[["c:\\\\Users\\\\kobez_000\\\\Documents\\\\Dev\\\\Snakeskin\\\\test\\\\test\\\\foo.ss",1413886610377],["c:\\\\Users\\\\kobez_000\\\\Documents\\\\Dev\\\\Snakeskin\\\\test\\\\test\\\\foo\\\\bar.ss",1413886610378]]>, generated at <1414919439246>.
...
(function() {
    ...
    function exec() {
        ...
        var $_ = __LOCAL__['$_5615f'];
        __LOCAL__.foo_0_5615f = 1;
        var bar_00_5615f = __LOCAL__.bar_00_5615f = 1;
        __LOCAL__.foo_1_5615f = 2;
        __LOCAL__.foo_2_5615f = 3; /* Snakeskin template: include.bar; name  */
        ...
        this.include['foo--'] = function(name) {
            ...
            __RESULT__.push(' ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__LOCAL__.foo_1_5615f), false, false));
            __RESULT__.push('!</h1> ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__LOCAL__.bar_00_5615f), false, false));
            __RESULT__.push(' ');
        ...
        this.include_index = function(name) {
            ...
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(name), false, false));
            __RESULT__.push(' ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__LOCAL__.foo_0_5615f), false, false));
            __RESULT__.push('!</h1> ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__LOCAL__.bar_00_5615f), false, false));
            __RESULT__.push(' ');
