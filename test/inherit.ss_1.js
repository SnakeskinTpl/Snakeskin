...
,xml,false,false,,stringConcat,true,true,true,,true,true,i18n>, label <1413886610347>, includes <>, generated at <1414919437076>.
...
(function() {
    ...
    function exec() {
        ...
        var $_ = __LOCAL__['$_076ff']; /* Snakeskin template: inherit_base; val val2  */
        this.inherit_base = function(val, val2) {
            ...
            __RESULT__ += __FILTERS__.html(__FILTERS__.undef(val2), false, false);
            __RESULT__ += ' ';
        ...
        this.inherit_sub = function(val) {
            ...
            ____I_PROTO___bar_template_44: while (____I_PROTO___bar_template_44--) {
                __RESULT__ += __FILTERS__.html(__FILTERS__.undef(__i__proto_350), false, false);
                __RESULT__ += ' ';
            }
            __RESULT__ += ' ';
            __RESULT__ += 'my';
        ...
        this.inherit_childTestConst2 = function() {
            ...
            ____I_PROTO___a_template_56: while (____I_PROTO___a_template_56--) {
                ...
                ____I_PROTO___e_template_56: while (____I_PROTO___e_template_56--) {
                    j = 1;
                    __RESULT__ += __FILTERS__.html(__FILTERS__.undef(j), false, false);
                    __RESULT__ += ' ';
                }
                __RESULT__ += ' ';
            }
        ...
        this.inherit_superTestConst3 = function() {
            ...
            __RESULT__ += ' ';
            __RESULT__ += __FILTERS__.html(__FILTERS__.undef(a.b), false, false);
            __RESULT__ += ' ';
            var a;
            return __RESULT__;
        };
