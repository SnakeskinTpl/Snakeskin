...
,xml,false,false,,stringBuffer,true,true,true,,true,true,i18n>, label <1413886610375>, includes <>, generated at <1414827001773>.
...
(function() {
    ...
    function exec() {
        ...
        var $_ = __LOCAL__['$_fe9af']; /* Snakeskin template: template;  */
        this.template = function() {
            ...
            var TPL_NAME = "template",
                PARENT_TPL_NAME;
            __RESULT__.push(__FILTERS__.html(($_ = __FILTERS__['repeat'].call(this, 'foo')), false, false));
            __RESULT__.push(' ');
