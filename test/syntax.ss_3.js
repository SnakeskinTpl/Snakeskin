...
,xml,false,false,,stringBuffer,true,true,true,,true,true,i18n>, label <1413886610373>, includes <>, generated at <1414919439009>.
...
(function() {
    ...
    function exec() {
        ...
        var $_ = __LOCAL__['$_33be8'];
        __LOCAL__.a_0_33be8 = 1; /* Snakeskin template: syntax_index;  */
        ...
        __LOCAL__.usingSnakeskin_0_33be8 = true; /* Snakeskin template: syntax_index5; name  */
        this.syntax_index5 = function(name) {
            ...
            __RESULT__.push((__TMP__['class'] ? ' class="' + __TMP__['class'] + '"' : '') + '>');
            if (__LOCAL__.usingSnakeskin_0_33be8) {
                __TMP__ = {
                    'class': ''
                };
                __RESULT__.push('<span');
