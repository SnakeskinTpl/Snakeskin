/* Snakeskin v4.0.0, label <1406961838471>, generated at <1407502635609> Fri Aug 08 2014 16:57:15 GMT+0400 (Московское время (зима)). This code is generated automatically, don't alter it. */
(function() {
    ...
    function exec() {
        ...
        var $_ = __LOCAL__['$_26ed0'];
        __LOCAL__.foo_0_26ed0 = 1;
        __LOCAL__.foo_1_26ed0 = 2;
        __LOCAL__.foo_2_26ed0 = 3; /* Snakeskin template: include.bar; name  */
        ...
        this.include.bar = function bar(name) {
            ...
            __RESULT__.push(' ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__LOCAL__.foo_2_26ed0), false));
            __RESULT__.push('!</h1> ');
        ...
        this.include['foo--'] = function(name) {
            ...
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(name), false));
            __RESULT__.push(' ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__LOCAL__.foo_1_26ed0), false));
            __RESULT__.push('!</h1> ');
            return __RESULT__.join('');
        };
        ...
        this.include_index = function(name) {
            ...
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(name), false));
            __RESULT__.push(' ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__LOCAL__.foo_0_26ed0), false));
            __RESULT__.push('!</h1> ');
            return __RESULT__.join('');
        };
