/* Snakeskin v4.0.0, label <1405615142208>, generated at <1407512254178> Fri Aug 08 2014 19:37:34 GMT+0400 (Московское время (зима)). This code is generated automatically, don't alter it. */
(function() {
    ...
    function exec() {
        ...
        var $_ = __LOCAL__['$_c5531']; /* Snakeskin template: inherit_base; val val2  */
        this.inherit_base = function(val, val2) {
            ...
            __RESULT__.push(' ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(val2), false));
            __RESULT__.push(' ');
            __RESULT__.push(' ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(val), false));
            __RESULT__.push(' ');
        ...
        this.inherit_sub = function(val) {
            ...
            ____I_PROTO___bar_template_44: while (____I_PROTO___bar_template_44--) {
                __RESULT__.push(' ');
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__i__proto_336), false));
                __RESULT__.push(' ');
            }
            __RESULT__.push(' ');
            __RESULT__.push(' ');
        ...
        this.inherit_childTestConst2 = function() {
            ...
            ____I_PROTO___a_template_56: while (____I_PROTO___a_template_56--) {
                ...
                ____I_PROTO___e_template_56: while (____I_PROTO___e_template_56--) {
                    ...
                    j = 1;
                    __RESULT__.push(' ');
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(j), false));
                    __RESULT__.push(' ');
                }
                __RESULT__.push(' ');
            }
        ...
        this.inherit_superTestConst3 = function() {
            ...
            __RESULT__.push(' ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(a.b), false));
            __RESULT__.push(' ');
            var a;
            return __RESULT__.join('');
        };
