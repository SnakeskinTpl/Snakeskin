/* Snakeskin v4.0.0, label <1404818331666>, generated at <1407579637975> Sat Aug 09 2014 14:20:37 GMT+0400 (Московское время (зима)). This code is generated automatically, don't alter it. */
(function() {
    ...
    function exec() {
        ...
        var $_ = __LOCAL__['$_ae0b6']; /* Snakeskin template: proto_index; i */
        this.proto_index = function(i) {
            ...
            ____I_PROTO___begin_template_44: while (____I_PROTO___begin_template_44--) {
                ...
                ____I_PROTO___f1_template_44: while (____I_PROTO___f1_template_44--) {
                    ...
                    ____I_PROTO___f2_template_44: while (____I_PROTO___f2_template_44--) {
                        __RESULT__.push(' ');
                        __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__i__proto_432), false));
                        __RESULT__.push(' ');
                    }
                    __RESULT__.push(' ');
            ...
            ____I_PROTO___f3_template_44: while (____I_PROTO___f3_template_44--) {
                __RESULT__.push(' ');
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__i__proto_352) * 2, false));
                __RESULT__.push(' ');
            }
            __RESULT__.push(' ');
            a = ({
            ...
            ____I_PROTO___f4_template_44: while (____I_PROTO___f4_template_44--) {
                ...
                __RESULT__.push(' ');
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__i__proto_496), false));
                __RESULT__.push(' ');
            }
            __RESULT__.push(' ');
            var a;
        ...
        this.proto_index2.a['foo'] = function() {
            var __THIS__ = this,
                callee = __ROOT__.proto_index2.a['foo'];
            if (!callee.Blocks) {
                var __BLOCKS__ = callee.Blocks = {},
                    blocks = __BLOCKS__;
            }
            ...
            ____I_PROTO___begin_template_54: while (____I_PROTO___begin_template_54--) {
                ...
                ____I_PROTO___f1_template_54: while (____I_PROTO___f1_template_54--) {
                    __RESULT__.push(' ');
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__i__proto_837), false));
                    __RESULT__.push(' ');
                }
                __RESULT__.push(' ');
            }
        ...
        this.proto_recursive = function() {
            var __THIS__ = this,
                callee = __ROOT__.proto_recursive;
            if (!callee.Blocks) {
                var __BLOCKS__ = callee.Blocks = {},
                    blocks = __BLOCKS__;
            }
            ...
            ____I_PROTO___begin_template_48: while (____I_PROTO___begin_template_48--) {
                __RESULT__.push(' ');
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__i__proto_928), false));
                __RESULT__.push(' ');
                if (__i__proto_928) {
                    __RESULT__.push(' ');
                    var __i__proto_928 = --__i__proto_928;
        ...
        this.proto_recursive2 = function() {
            var __THIS__ = this,
                callee = __ROOT__.proto_recursive2;
            if (!callee.Blocks) {
                var __BLOCKS__ = callee.Blocks = {},
                    blocks = __BLOCKS__;
            }
            ...
            ____I_PROTO___begin_template_49: while (____I_PROTO___begin_template_49--) {
                __RESULT__.push(' ');
                __RESULT__.push(' ');
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__i__proto_1061), false));
                __RESULT__.push(' ');
                if (__i__proto_1061) {
                    __RESULT__.push(' ');
                    ...
                    ____I_PROTO___foo_template_49: while (____I_PROTO___foo_template_49--) {
                        ...
                        __RESULT__.push(' ');
                        var __i__proto_1061 = __i__proto_1079;
