/* Snakeskin v4.0.0, label <1404818331666>, generated at <1407319258369> Wed Aug 06 2014 14:00:58 GMT+0400 (Московское время (зима)). This code is generated automatically, don't alter it. */
(function() {
    ...
    function exec() {
        ...
        var $_ = __LOCAL__['$_5d2b0']; /* Snakeskin template: proto_index; i */
        this.proto_index = function(i) {
            ...
            ____I_PROTO___begin_template_44: while (____I_PROTO___begin_template_44--) {
                ...
                ____I_PROTO___f1_template_44: while (____I_PROTO___f1_template_44--) {
                    ...
                    ____I_PROTO___f2_template_44: while (____I_PROTO___f2_template_44--) {
                        __RESULT__.push(' ');
                        __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__i__proto_432)));
                        __RESULT__.push(' ');
                    }
                    __RESULT__.push(' ');
            ...
            ____I_PROTO___f3_template_44: while (____I_PROTO___f3_template_44--) {
                __RESULT__.push(' ');
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__i__proto_352) * 2));
                __RESULT__.push(' ');
            }
            __RESULT__.push(' ');
            a = ({
            ...
            ____I_PROTO___f4_template_44: while (____I_PROTO___f4_template_44--) {
                ...
                __RESULT__.push(' ');
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__i__proto_496)));
                __RESULT__.push(' ');
            }
            __RESULT__.push(' ');
            var a;
        ...
        this.proto_index2.a['foo'] = function() {
            ...
            ____I_PROTO___begin_template_54: while (____I_PROTO___begin_template_54--) {
                ...
                ____I_PROTO___f1_template_54: while (____I_PROTO___f1_template_54--) {
                    __RESULT__.push(' ');
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__i__proto_837)));
                    __RESULT__.push(' ');
                }
                __RESULT__.push(' ');
            }
        ...
        this.proto_recursive = function() {
            ...
            ____I_PROTO___begin_template_48: while (____I_PROTO___begin_template_48--) {
                __RESULT__.push(' ');
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__i__proto_928)));
                __RESULT__.push(' ');
                if (__i__proto_928) {
                    __RESULT__.push(' ');
        ...
        this.proto_recursive2 = function() {
            ...
            ____I_PROTO___begin_template_49: while (____I_PROTO___begin_template_49--) {
                __RESULT__.push(' ');
                __RESULT__.push(' ');
                __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__i__proto_1061)));
                __RESULT__.push(' ');
                if (__i__proto_1061) {
                    __RESULT__.push(' ');
