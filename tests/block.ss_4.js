/* Snakeskin v4.0.0, label <1406783485267>, generated at <1407338186636> Wed Aug 06 2014 19:16:26 GMT+0400 (Московское время (зима)). This code is generated automatically, don't alter it. */
(function() {
    ...
    function exec() {
        ...
        var $_ = __LOCAL__['$_d54bd']; /* Snakeskin template: block_base;  */
        this.block_base = function() {
            ...
            __RESULT__.push(__BLOCKS__.base(__a__template_49, __b__template_49, __c__template_49));
            if (!__BLOCKS__.base2) {
                __BLOCKS__.base2 = function(__a__block_150, __b__block_150, __c__block_150) {
                    ...
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__a__block_150), false));
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__b__block_150), false));
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__c__block_150), false));
                    return __RESULT__.join('');
                };
            }
        ...
        this.block_sub = function() {
            ...
            if (!__BLOCKS__.base) {
                __BLOCKS__.base = function(__a__block_272) {
                    ...
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__a__block_272), false));
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__b__block_272), false));
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__c__block_272), false));
                    return __RESULT__.join('');
                };
            }
            __RESULT__.push(__BLOCKS__.base(__a__template_281, __b__template_281, __c__template_281));
            if (!__BLOCKS__.base2) {
                __BLOCKS__.base2 = function(__a__block_381) {
                    ...
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__a__block_381), false));
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__b__block_381), false));
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__c__block_381), false));
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__a__block_381.aa), false));
                    return __RESULT__.join('');
                };
            }
            __RESULT__.push(__BLOCKS__.base2(null));
            __RESULT__.push(blocks.base2(5, 4, __b__template_281));
            return __RESULT__.join('');
        };
        ...
        this.block_base2 = function() {
            ...
            if (!__BLOCKS__.base) {
                __BLOCKS__.base = function(__a__block_615, __b__block_615, __c__block_615) {
                    ...
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__a__block_615), false));
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__b__block_615), false));
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__c__block_615), false));
                    if (!__BLOCKS__.base2) {
                        __BLOCKS__.base2 = function(__a__block_677, __b__block_677, __c__block_677) {
                            ...
                            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__a__block_677), false));
                            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__b__block_677), false));
                            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__c__block_677), false));
                            return __RESULT__.join('');
                        };
                    }
                    __RESULT__.push(__BLOCKS__.base2(0, __a__block_615, 1));
                    return __RESULT__.join('');
                };
            }
            __RESULT__.push(__BLOCKS__.base(__a__template_581, __b__template_581, __c__template_581));
            return __RESULT__.join('');
        };
        ...
        this.block_sub2 = function() {
            ...
            if (!__BLOCKS__.base) {
                __BLOCKS__.base = function(__a__block_819, __b__block_819, __c__block_819) {
                    ...
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__a__block_819), false));
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__b__block_819), false));
                    __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__c__block_819), false));
                    if (!__BLOCKS__.base2) {
                        __BLOCKS__.base2 = function(__a__block_796) {
                            ...
                            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__a__block_796), false));
                            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__b__block_796), false));
                            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__c__block_796), false));
                            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(__a__block_796.aa), false));
                            return __RESULT__.join('');
                        };
                    }
                    __RESULT__.push(__BLOCKS__.base2(null));
            ...
            __RESULT__.push(__BLOCKS__.base(__a__template_785, __b__template_785, __c__template_785));
            return __RESULT__.join('');
        };
