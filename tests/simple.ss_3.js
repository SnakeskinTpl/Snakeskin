/* Snakeskin v4.0.0, label <1405794071621>, generated at <1407319258424> Wed Aug 06 2014 14:00:58 GMT+0400 (Московское время (зима)). This code is generated automatically, don't alter it. */
(function() {
    ...
    function exec() {
        ...
        var $_ = __LOCAL__['$_bf92d']; /* Snakeskin template: simple_output;  */
        ...
        this.simple_index = function(name, lname) {
            ...
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(name)));
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(lname) ? ' ' + lname : ''));
        ...
        this.simple_tpl.foo['index'] = function(name, lname) {
            ...
            a = 1;
            __RESULT__.push(' ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(a) === 1 ? 1 : 2));
