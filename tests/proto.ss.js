...
(function() {
    ...
    function exec() { /* Snakeskin template: proto_index; i */
        ...
        if (typeof Snakeskin !== 'undefined') {
            Snakeskin.cache['proto_index'] = this.proto_index;
        } /* Snakeskin template. */ /* Snakeskin template: proto_index2.a['foo'];  */
        ...
        if (typeof Snakeskin !== 'undefined') {
            Snakeskin.cache['proto_recursive2'] = this.proto_recursive2;
        } /* Snakeskin template. */
    }
}).call(this);