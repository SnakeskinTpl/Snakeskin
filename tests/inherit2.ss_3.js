/* Snakeskin v4.0.0, label <1406542584159>, generated at <1407579637894> Sat Aug 09 2014 14:20:37 GMT+0400 (Московское время (зима)). This code is generated automatically, don't alter it. */
(function() {
    ...
    function exec() {
        ...
        var $_ = __LOCAL__['$_17c76']; /* Snakeskin template: inherit2_base;  */
        ...
        this.inherit2_sub = function() {
            ...
            b33 = 34;
            b13 = 2;
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(a1), false));
            __RESULT__.push(' ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(b33), false));
            __RESULT__.push(' ');
            __RESULT__.push(__FILTERS__.html(__FILTERS__.undef(b13), false));
            __RESULT__.push(' ');
            try {
