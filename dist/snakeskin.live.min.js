/*! Snakeskin v7.0.0-beta10 (live) | https://github.com/SnakeskinTpl/Snakeskin/blob/master/LICENSE */
...
b,{value:d,enumerable:!0,configurable:!0,writable:!0}):a[b]=d;return a};f;var c={VERSION:[7,0,0,"beta10"],UID:null,b:{},Filters:{},Vars:{},LocalVars:{},cache:{}};Array.isArray=Array.isArray||function(a){return"[object Array]"==={}.call(a)};String.prototype.trim=String.prototype.trim||function(){for(var a=this.replace(/^\s\s*/,""),b=a.length,d=/\s/;d.test(a.charAt(--b)););return a.substring(0,b+1)};c.HTMLObject=function(a,b){this.value=a;this.attr=b};c.StringBuffer=function(){return[]};c.Node=function(){};
...
a?b:a};c.setFilterParams("default",{"!undef":!0});var N=/\r?\n|\n/g;e.nl2br=function(a,b,d,f,g){a=a.split(N);for(var m="",h=0;h<a.length;h++){var n=a[h],k=h===a.length-1;f||C[d]?(m+=e.html(n),k||(m+="<br"+("xml"===g?"/":"")+">")):(c.appendChild(b,n,d),k||c.appendChild(b,new c.Element("br",d),d))}return m};e.nl2br.ssFilterParams={"!html":!0,bind:["$0",function(a){return"'"+a.renderMode+"'"},function(a){return a.stringResult},"$0",function(a){return"'"+a.doctype+"'"}]};e.attrKey=e.attrKeyGroup=function(a){return(a=
v.exec(String(a)))&&a[1]||"undefined"};e.attrKeyGroup=function(a){return(a=v.exec(String(a)))&&a[1]||""};var O=/(javascript)(:|;)/g;e.attrVal=function(a){return String(a).replace(O,"$1&#31;$2")};e.attr=function(a,b,d,f,g,h){function k(a,b){b=b||"";c.forEach(a,function(a,c){if(a!==h){if(Boolean(a)&&a.constructor===Object){var d=e.attrKeyGroup(c);return k(a,b+(!d.length||u[d.slice(-1)]?d:d+"-"))}for(var d=b+c,g=d[0].toLowerCase(),l=1;l<d.length;l++){var q=d.charAt(l),p=q.toUpperCase();p===q&&p!==q.toLowerCase()?
g+="-"+q:g+=q}d=g;f[d]=n[d]=[a]}});return new c.HTMLObject(n,"attrVal")}if("attrKey"!==d||!Boolean(a)||a.constructor!==Object)return String(a);var n={};return k(a)};c.setFilterParams("attr",{"!html":!0,bind:[function(a){return"'"+a.doctype+"'"},"__ATTR_TYPE__",function(a){return a.out("__ATTR_CACHE__",{unsafe:!0})},"TRUE","FALSE"],test:function(a){return l(a)}});return c}
