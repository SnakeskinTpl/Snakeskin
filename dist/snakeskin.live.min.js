/*! Snakeskin v7.0.0-beta11 (live) | https://github.com/SnakeskinTpl/Snakeskin/blob/master/LICENSE */
...
b,{value:d,enumerable:!0,configurable:!0,writable:!0}):a[b]=d;return a};f;var c={VERSION:[7,0,0,"beta11"],UID:null,b:{},Filters:{},Vars:{},LocalVars:{},cache:{}};Array.isArray=Array.isArray||function(a){return"[object Array]"==={}.call(a)};String.prototype.trim=String.prototype.trim||function(){for(var a=this.replace(/^\s\s*/,""),b=a.length,d=/\s/;d.test(a.charAt(--b)););return a.substring(0,b+1)};c.HTMLObject=function(a,b){this.value=a;this.attr=b};c.StringBuffer=function(){return[]};c.Node=function(){};
