/*!
 * Snakeskin v7.0.0-beta11
 * https://github.com/SnakeskinTpl/Snakeskin
 *
 * Released under the MIT license
 * https://github.com/SnakeskinTpl/Snakeskin/blob/master/LICENSE
 *
 * Date: 'Fri, 12 Feb 2016 20:47:51 GMT
 */
...
(function (global, factory) {
    ...
    Parser.prototype.getXMLTagDeclEnd = function (opt_inline) {
    	...
    	return ws$1(_templateObject3$8, this.declVars('__CALL_CACHE__ = __RESULT__', { sys: true }), isDOMRenderMode ? this.declVars('__NODE__ = $0', { sys: true }) : '', this.getVar('__TAG__'), Boolean(opt_inline), '__INLINE_TAGS__[' + this.getVar('__TAG__') + ']', isDOMRenderMode, this.doctype === 'xml');
    };
