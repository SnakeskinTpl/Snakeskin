...
"").toUpperCase()};e.Filters.ucfirst=function(a){a=a+"";return a.charAt(0).toUpperCase()+a.substring(1)};e.Filters.lower=function(a){return(a+"").toLowerCase()};e.Filters.lcfirst=function(a){a=a+"";return a.charAt(0).toLowerCase()+a.substring(1)};e.Filters.trim=function(a){return(a+"").trim()};var x=/\s{2,}/g;e.Filters.collapse=function(a){return(a+"").replace(x," ").trim()};e.Filters.truncate=function(a,c,b,d){a=a+"";if(!a||a.length<=c)return a;a=a.substring(0,c-1);c=void 0;for(var f=a.length;f--&&
b;)if(" "===a.charAt(f))c=f;else if(void 0!==c)break;return(void 0!==c?a.substring(0,c):a)+(d?"&#8230;":"\u2026")};e.Filters.repeat=function(a,c){return Array(null!=c?c+1:3).join(a)};e.Filters.remove=function(a,c){return(a+"").replace(c,"")};e.Filters.replace=function(a,c,b){return(a+"").replace(c,b)};e.Filters.json=function(a){return"object"===typeof a?JSON.stringify(a):a+""};e.Filters.parse=function(a){return"string"!==typeof a?a:JSON.parse(a)};e.Filters.bem=function(a,c){return a+""+(c+"")};if(/\[\w+ \w+]/.test(Object.keys&&
