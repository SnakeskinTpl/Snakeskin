...
a+"}\">';"))};Snakeskin.Directions.bemEnd=function(a,c,b){a=b.popPos("bem");b.protoStart||b.save("__SNAKESKIN_RESULT__ += '</"+(a.tag||a.original||"div")+">';")};Snakeskin.Directions.end=function(a,c,b,d){b.openBlockI--;var e=this,f=arguments,h=b.openBlockI+1,g;0===b.openBlockI?this.Directions.templateEnd.apply(this,arguments):b.isNotSysPos(h)&&(this.forEach(b.posCache,function(a,c){if((a=b.getLastPos(c))&&("undefined"!==typeof a.i&&a.i===h||a===h))return g=!0,e.Directions[c+"End"].apply(e,f),!1}),
!g&&(!b.parentTplName&&!b.protoStart)&&b.save("};"));this.forEach(b.sysPosCache,function(a,c){if((a=b.getLastPos(c))&&("undefined"!==typeof a.i&&a.i===h||a===h))return e.Directions[c+"End"].apply(e,f),!1})};var y;if(s)for(y in Snakeskin)Snakeskin.hasOwnProperty(y)&&(exports[y]=Snakeskin[y])})("undefined"===typeof window);
