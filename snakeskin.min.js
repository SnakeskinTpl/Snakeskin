...
"":"var ")+b+";",!0)))}else a.save("if (typeof Snakeskin !== 'undefined') { Snakeskin.Vars."+a.prepareOutput(b,!0,null,!0)+"; }")}else f||(h||!d)||a.save("__SNAKESKIN_RESULT__ += "+a.prepareOutput(b)+";");else a.save(a.prepareOutput(b)+";")};Snakeskin.Directions.cut=function(b,c,a){b=a.pasteDangerBlocks(b);Snakeskin.write[b]||(Snakeskin.write[b]=!1)};Snakeskin.Directions.save=function(b,c,a){Snakeskin.write[a.pasteDangerBlocks(b)]=!0};Snakeskin.Directions.setBEM=function(b,c,a){b=b.match(/([\s\S]*?),\s+([\s\S]*)/m);
